# A vector of (1,2,3,...,19,20)
1:20
#A vector of (20,19,18,...,2,1)
20:1
# temp = c(20,19,18,...,2,1)
temp <- 20:1
# temp = c(4,6,3)
...
# replicate vector temp 10 times
rep(temp, 10)
#
# replicate vector temp with a total length of 31
rep(temp, l=31)
#
# replicate 1st element 10 times, replicate 2nd 20 times, and thrid 30 times
rep(temp, times=c(10,20,30))
#
# generate vector (3,3.1,3.2, ...,6 )
temp <- seq(3,6, by=0.1)
temp
#
#vector of exp(x)cos(x) at x = 3,3.1,3.2,...,6
exp(temp)*cos(temp)
#
# vector (10,11,12,...,100)
temp <- 10:100
# sum over i (from 10 to 100) {i^3 + 4 i^2}
sum(temp^3+4*temp^2)
#
# pick a seed to generate random integers
set.seed(50)
#generate a vector of 250 random integers between 0-999 with replacement
yvec <- sample(0:999, 250, replace = T)
yvec[1:10]
#
# yvec > 600
yvec>600
# a vector from yvec where elements > 600
temp <- yvec[yvec > 600]
length(yvec)
#
which(yvec > 600)
